...
namespace UnityEditor.Tilemaps
{
    internal class GridPaintPaletteWindowSplitView : VisualElement
    {
        ...
        private const float kInitialSize = 164f;
        ...
        public GridPaintPaletteWindowSplitView(bool isVerticalOrientation)
        {
            ...
            m_SplitView = new TwoPaneSplitView(0, kInitialSize, isVerticalOrientation ? TwoPaneSplitViewOrientation.Vertical : TwoPaneSplitViewOrientation.Horizontal);
            ...
            m_SplitView.fixedPaneInitialDimension = kInitialSize;
            Add(m_SplitView);
