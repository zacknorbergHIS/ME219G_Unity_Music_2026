...
namespace UnityEditor.Tilemaps
{
    internal class TilePaletteBrushInspector
    {
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent sceneViewZPosition = EditorGUIUtility.TrTextContent("Scene View Z Position", "Set a Z position for the active Brush for painting in the Scene View");
