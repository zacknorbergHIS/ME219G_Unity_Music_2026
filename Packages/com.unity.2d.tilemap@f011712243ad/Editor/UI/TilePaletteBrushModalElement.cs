...
namespace UnityEditor.Tilemaps
{
    internal class TilePaletteBrushModalElement : VisualElement
    {
        ...
        public TilePaletteBrushModalElement()
        {
            ...
            var leftToolbarElements = new VisualElement();
            leftToolbarElements.AddToClassList(leftToolbarUssClassName);
            leftToolbarElements.Add(new TilePaletteBrushesPopup());
