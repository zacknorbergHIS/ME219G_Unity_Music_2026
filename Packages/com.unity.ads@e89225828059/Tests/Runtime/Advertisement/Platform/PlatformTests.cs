...
namespace UnityEngine.Advertisements.Tests
{
    public class PlatformTests
    {
        ...
        {
            m_NativePlatformMock.Setup(x => x.Load(It.IsAny<string>(), It.IsAny<LoadOptions>(), It.IsAny<IUnityAdsLoadListener>()));
            var platform = new Platform.Platform(m_NativePlatformMock.Object, m_BannerMock.Object, m_CoroutineExecutorMock.Object);
            platform.Load(placementId, null);
            m_NativePlatformMock.Verify(x => x.Load(It.IsAny<string>(), It.IsAny<LoadOptions>(), It.IsAny<IUnityAdsLoadListener>()), Times.Once(), "NativePlatform.Load() was not called as expected");
        }
        ...
        public void NativePlatformLoadError(string placementId)
        {
            ...
            m_NativePlatformMock.Verify(x => x.Load(It.IsAny<string>(), It.IsAny<LoadOptions>(), It.IsAny<IUnityAdsLoadListener>()), Times.Never(), "NativePlatform.Load() was called when it should not have been");
        }
        ...
        {
            m_NativePlatformMock.Setup(x => x.Show(It.IsAny<string>(), It.IsAny<string>(), null));
            var platform = new Platform.Platform(m_NativePlatformMock.Object, m_BannerMock.Object, m_CoroutineExecutorMock.Object);
            platform.Show(placementId, null, null);
            m_NativePlatformMock.Verify(x => x.Show(It.IsAny<string>(), It.IsAny<string>(), null), Times.Once(), "NativePlatform.Show() was not called as expected");
        }

        [Test]
        [TestCase("placement")]
        public void NativePlatformCheckObjectIds(string placementId)
        {
            string objectId = "";
            m_NativePlatformMock.Setup(x => x.Load(It.IsAny<string>(), It.IsAny<LoadOptions>(), It.IsAny<IUnityAdsLoadListener>()))
                .Callback<String, LoadOptions, IUnityAdsLoadListener>((placementId, loadOptions, listener) => {
                    objectId = loadOptions.ObjectId;
            });
            var platform = new Platform.Platform(m_NativePlatformMock.Object, m_BannerMock.Object, m_CoroutineExecutorMock.Object);
            platform.Load(placementId, null);
            m_NativePlatformMock.Verify(x => x.Load(It.IsAny<string>(), It.IsAny<LoadOptions>(), It.IsAny<IUnityAdsLoadListener>()), Times.Once(), "NativePlatform.Load() was not called as expected");
            ...
            m_NativePlatformMock.Setup(x => x.Show(It.IsAny<string>(), It.IsAny<string>(), null));
            platform.Show(placementId, null, null);
            m_NativePlatformMock.Verify(x => x.Show(It.IsAny<string>(), objectId, null), Times.Once(), "NativePlatform.Show() was not called as expected");
        }
