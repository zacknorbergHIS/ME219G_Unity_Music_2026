...
namespace UnityEngine.Advertisements.Platform.iOS
{
    internal class IosPlatform : IosNativeObject, INativePlatform, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
    {
        ...
        [DllImport("__Internal")]
        private static extern void UnityAdsLoad(string placementId, string objectId, IntPtr loadListener);

        [DllImport("__Internal")]
        private static extern void UnityAdsShow(string placementId, string objectId, IntPtr showListener);
        ...
        {
            UnityAdsLoad(placementId, loadOptions.ObjectId, new IosLoadListener(this, loadListener).NativePtr);
        }

        public void Show(string placementId, string objectId, IUnityAdsShowListener showListener)
        {
            UnityAdsShow(placementId, objectId, new IosShowListener(this, showListener).NativePtr);
        }
