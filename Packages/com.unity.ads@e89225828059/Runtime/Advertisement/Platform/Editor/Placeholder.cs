...
namespace UnityEngine.Advertisements
{
    internal sealed class Placeholder : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_LandscapeTexture = AssetDatabase.LoadAssetAtPath<Texture2D>("Landscape") as Texture2D;
            m_PortraitTexture = AssetDatabase.LoadAssetAtPath<Texture2D>("Portrait") as Texture2D;
